import svgPaths from "./svg-zk18pocln2";
      ...
      <div className="absolute aspect-[18/18] left-[44.54%] right-[44.25%] top-[calc(50%-34.5px)] translate-y-[-50%]" data-name="Vector">
        <div className="absolute inset-[-5.56%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43 43">
            <path d={svgPaths.p34e77700} id="Vector" stroke="url(#paint0_linear_29_484)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4.22222" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_29_484" x1="2.11111" x2="40.1111" y1="21.1111" y2="21.1111">
