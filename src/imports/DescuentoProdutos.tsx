import svgPaths from "./svg-vwsicoa6g6";
    ...
    <button className="absolute block cursor-pointer left-[127px] size-[44px] top-0">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
        <g id="Frame 85">
          ...
          <rect height="43" rx="4.5" stroke="url(#paint0_linear_28_1549)" width="43" x="0.5" y="0.5" />
          <path d={svgPaths.p28b56e40} id="Vector" stroke="url(#paint1_linear_28_1549)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_28_1549" x1="0" x2="52.6721" y1="0" y2="27.2174">
            <stop stopColor="#092090" />
            <stop offset="1" stopColor="#0C2ABF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_28_1549" x1="17" x2="31.0125" y1="13" y2="17.0226">
            <stop stopColor="#092090" />
            <stop offset="1" stopColor="#0C2ABF" />
          </linearGradient>
        </defs>
